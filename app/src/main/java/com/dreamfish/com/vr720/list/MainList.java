package com.dreamfish.com.vr720.list;
...
public class MainList {
    ...
    private List<MainListItem> selectedItems = new ArrayList<>();
    ...
    //图片点击事件
    private View.OnClickListener mainListBaseOnClickListener = new View.OnClickListener() {
        @Override
    ...
    //图片长按事件
    private View.OnLongClickListener mainListBaseOnLongClickListener = new View.OnLongClickListener() {
        @Override
