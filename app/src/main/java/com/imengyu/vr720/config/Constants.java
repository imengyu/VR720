...
public class Constants {
    ...
    public static final String ARGEEMENY_URL = "https://imengyu.top/linkJump?to=vr720_argeement";
    public static final String PRIVACY_POLICY_URL = "https://imengyu.top/linkJump?to=privacy_policy";
